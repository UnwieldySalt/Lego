...
function add1(){
    ...
    document.getElementById("marioloadded").innerHTML =  "Fire Truck Set: " + fireVal + " " + 
...
function add2(){
    ...
    document.getElementById("airloadded").innerHTML =  "Spaceship Set: " + airVal + " " + 
...
function add3(){
    ...
    document.getElementById("waterloadded").innerHTML =  "Pirate Set: " + waterVal + " " + 
...
function buyalertbasket()
{
    if(fireVal+airVal+waterVal+ass1Val+ass1Val+ass2Val+ass3Val > 0)
    {
        alert("Item(s) Bought");
    }
}